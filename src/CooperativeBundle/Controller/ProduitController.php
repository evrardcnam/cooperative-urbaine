...
use CooperativeBundle\Entity\Produit;
use CooperativeBundle\Form\ProduitType;
...
class ProduitController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CooperativeBundle:Produit')->findAll();

        return $this->render('CooperativeBundle:Produit:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CooperativeBundle:Produit:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CooperativeBundle:Produit')->find($id);
        ...
        return $this->render('CooperativeBundle:Produit:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CooperativeBundle:Produit:edit.html.twig', array(
            'entity'      => $entity,

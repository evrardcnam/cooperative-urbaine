...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony-cooperative-urbaine', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\CooperativeBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'CooperativeBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('CooperativeBundle' => 'CooperativeBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_99d11ef3f8c47d745684aa9269a2e6c34e597338c8f1f2355fb976b38f2703f9');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/production');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/produit');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/consomacteur');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/maraicher');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/membre');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/adresse');
        ...
        $r = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $q, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($q, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        $r->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $s = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($q, array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $s->setProviderKey('main');

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($p, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => $r, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $q, 'main', $s, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $q, array('login_path' => 'fos_user_security_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '54bfe5162cc63', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $p, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $q, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $q, 'fos_user_security_login', false), NULL, NULL, $a));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\CooperativeBundle/Resources/views'), 'Cooperative');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2cbb47d8e3e3c8c0d82d72f4b5510dd510');
    }
    ...
    {
        return $this->services['user.registration.form.type'] = new \UserBundle\Form\Type\RegistrationFormType('UserBundle\\Entity\\User', array('ROLE_USER' => 'utilisateur', 'ROLE_SPEC' => 'gestionnaire des spectacles', 'ROLE_ADMIN' => 'administrateur', 'ROLE_PROG' => 'programmateur'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CooperativeBundle' => 'CooperativeBundle\\CooperativeBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'symfony-cooperative-urbaine',
            'database_user' => 'root',
            ...
            'locale' => 'fr',
            'secret' => '2cbb47d8e3e3c8c0d82d72f4b5510dd510',
            'debug_toolbar' => true,
            ...
            'kernel.secret' => '2cbb47d8e3e3c8c0d82d72f4b5510dd510',
            ...
            'roles' => array(
                ...
                'ROLE_SPEC' => 'gestionnaire des spectacles',
                'ROLE_ADMIN' => 'administrateur',
                'ROLE_PROG' => 'programmateur',
            ),
